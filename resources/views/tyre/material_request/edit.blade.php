        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" id="create_form" method="post" action="{{route('tyre_material_request.update',$mtr->id)}}" enctype="multipart/form-data">
              {{csrf_field()}}
              @method('PATCH')             
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12">                                     
                            <div class='row'>                         
                              <div class="col-md-4 col-xl-4 mt-2">
                                  ...
                                  <input id="mtr_no" name="mtr_no" readonly="true" class="form-control  " value="{{$mtr->mtr_no}}">
                                  @error('mtr_no')
                              ...
                              <div class="col-md-4 col-xl-4 mt-2">
                                  ...
                                  <input id="mtr_date" name="mtr_date" class="form-control datepicker" readonly="true" value="{{$mtr->mtr_date}}">
                                  @error('mtr_date')
                                  <span class="invalid-feedback d-block" role="alert">
                              ...
                              <div class="col-md-4 col-xl-4 mt-2">
                                  ...
                                  <input id="email" name="prep_by" class="form-control  " value="{{old('prep_by') ? old('prep_by') :$mtr->prep_by  }}">
                                  @error('prep_by')
                                  <span class="invalid-feedback d-block" role="alert">
                                                ...
                                                foreach($ids as $id){
                                                  foreach($ses_data[$id] as $data){ ?>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <td>
                                                      <input id="tyre_order_qty" name="tyre_order_qty[]" class="form-control qty" value="{{$data['order_qty']}}">
                                                    </td>
                                                    <td>
                                                      <input id="tyre_request" name="tyre_request[]" class="form-control  " value="{{$data['request_by']}}">
                                                    </td>
                                                    <td>
                                                      <input id="tyre_remark" name="tyre_remark[]" class="form-control  " value="{{$data['tyre_remark']}}">
                                                    </td>
                                                    <td>
                    ...
                    <div class="row">
                      <div class="col-md-2 col-xl-2 mt-2">
                         <label class="" for="Chasis No">Total Qty</label>
                          ...
                          <input readonly="true" id="total_qty" name='total_qty' class="form-control  total" value="{{$mtr->total_qty}}">
                          @error('remarks')
                          <span class="invalid-feedback d-block" role="alert">
                             <strong>{{ 'Please enter prepared by name in alphabets' }}</strong>
                          </span>
