        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            <div class="col-sm-6 col-md-6">
                <h3>UPDATE TYRE SUPPLIER DETAILS </h3>
            ...
            <div id="add-city-form">
             <form class="well form-horizontal" method="post" action="{{route('tyrevendor.update',$data->id)}}"  enctype="multipart/form-data">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                            	 ...
                            	 <div class="col-md-3 col-xl-3 mt-2">
                            	 	<div class="funkyradio">
								        <div class="funkyradio-default">
								            <input {{$data->vendor_type == 'tyre supplier' ? 'checked':''}} value="tyre supplier" type="radio" name="vendor_type" id="radio1" />
                            	 ...
                            	 <div class="col-md-3 col-xl-3 mt-2">
                            	 	<div class="funkyradio">
								        <div class="funkyradio-primary">
								            <input {{$data->vendor_type == 'remolding company' ? 'checked':''}} type="radio" value="remolding company" name="vendor_type" id="radio2" />
                            	 ...
                            	 <div class="col-md-3 col-xl-3 mt-2">
                            	 	<div class="funkyradio">
								        <div class="funkyradio-success">
								            <input {{$data->vendor_type == 'repairing vendor' ? 'checked':''}} value="repairing vendor" type="radio" name="vendor_type" id="radio3" />
