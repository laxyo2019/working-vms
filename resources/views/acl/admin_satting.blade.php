				...
				<div class="card-body " >
					<div class="row">
						<div class="col-sm-12 col-md-12 col-xl-12  table-responsive " id="mytable1">
							<a style="margin-left: 18px;margin-bottom: 10px;" href="{{route('admin.create')}}" id="add" type="button" class="btn btn-info">Add</a>
					...
					<div class="col-sm-12 col-md-12 col-xl-12  table-responsive " id="mytable2" style="display: none;">
						<a style="margin-left: 18px;margin-bottom: 10px;" href="{{route('permissions.create')}}" id="add" type="button" class="btn btn-info">Add</a>
					...
					<div class="col-sm-12 col-md-12 col-xl-12  table-responsive " style="display: none;" id="mytable3">
						<a style="margin-left: 18px;margin-bottom: 10px;" href="{{route('users.create')}}" id="add" type="button" class="btn btn-info">Add</a>
