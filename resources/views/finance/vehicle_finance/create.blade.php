          ...
          <div class="box-title">
            ...
            <div class="col-sm-6 col-md-6">
              ...
              <div id="add-city-form">
                <form class="well well1 " method="post" action="{{route('vehiclefinance.store')}}"  enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="row">
                                    ...
                                    <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xl-12" >
                                                ...
                                                <div class="col-md-6 col-xl-6 mt-2">
                                                    ...
                                                    <input id="customer_name" class="form-control" name="customer_name" value="" > 
                                                </div>
                                                
                                                <div class="col-md-6 col-xl-6 mt-2">
                                                    <label for="guranter_name">Guranter Name</label>
                                                    <input id="guranter_name" type="text" name="guranter_name" class="form-control" value="{{ old('guranter_name') }}">
                                                </div>

                                                <div class="col-md-6 col-xl-6 mt-2">
                                                    <label for="customer_address">Customer Address</label>
                                                    <textarea id="customer_address" type="text" name="customer_address" class="form-control" value="{{ old('customer_address') }}"></textarea> 
                                                </div>

                                                <div class="col-md-6 col-xl-6 mt-2">
                                                    <label for="guranter_address">Guranter Address</label>
                                                    <textarea id="guranter_address" type="text" name="guranter_address" class="form-control" value="{{ old('guranter_address') }}"></textarea> 
                                                </div>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-12 col-xl-12">
                                          ...
                                          <div class="col-md-4 col-xl-4 mt-2">
                                              ...
                                              <input id="contract_no" class="form-control" name="contract_no" value="" > 
                                          </div>
                                          
                                          <div class="col-md-4 col-xl-4 mt-2">
                                              <label for="contract_date">Contract Date</label>
                                              <input id="contract_date" readonly="true"  name="contract_date" class="form-control datepicker" value="{{ old('contract_date') }}">
                                          </div>

                                          <div class="col-md-4 col-xl-4 mt-2">
                                              <label for="contract_period">Contract Period</label>
                                              <input id="contract_period" type="text"  name="contract_period" class="form-control " value="{{ old('contract_period') }}" placeholder="In Months">
                                          </div>

                                          <div class="col-md-4 col-xl-4 mt-2">
                                              <label for="expair_date">Expair Date
                                              </label>
                                              <input id="expair_date" readonly="true" name="expair_date" class="form-control datepicker" value="{{ old('expair_date') }}">
                                          </div>

                                          <div class="col-md-4 col-xl-4 mt-2">
                                              <label for="finance_rate">Finance Rate(%)</label>
                                              <input id="finance_rate" type="number" name="finance_rate" class="form-control" value="{{ old('finance_rate') }}">
                                          </div>

                                          <div class="col-md-4 col-xl-4 mt-2">
                                              <label for="moratorium">Moratorium</label>
                                              <input id="moratorium" type="text" name="moratorium" class="form-control" value="{{ old('moratorium') }}">
                                          </div>
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                          ...
                                          <div class="col-md-6 col-xl-6 mt-2">
                                              ...
                                              <input id="engine_no" type="text" name="engine_no" class="form-control" value="{{ old('engine_no') }}">
                                          </div>

                                          <div class="col-md-6 col-xl-6 mt-2">
                                              <label for="chassis_no">Chassis No</label>
                                              <input id="chassis_no" type="text" name="chassis_no" class="form-control" value="{{ old('chassis_no') }}">
                                          </div>

                                          <div class="col-md-6 col-xl-6 mt-2">
                                              <label for="reg_no">Reg. No
                                              </label>
                                              <input id="reg_no" type="text" name="reg_no" class="form-control" value="{{ old('reg_no') }}">
                                          </div>
                                        </div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xl-12">
                                                ...
                                                <div class="col-md-12 col-xl-12 mt-2">
                                                    ...
                                                    <input id="finance_com_name" class="form-control" name="finance_com_name" value="" > 
                                                </div>
                                                
                                                <div class="col-md-3 col-xl-3 mt-2">
                                                    <label for="finance_amount">Finance Amount</label>
                                                    <input id="finance_amount" type="text" name="finance_amount" class="form-control" value="{{ old('finance_amount') }}">
                                                </div>

                                                <div class="col-md-3 col-xl-3 mt-2">
                                                    <label for="total_amount">Total Amount </label>
                                                    <input id="total_amount" type="text" name="total_amount" class="form-control" readonly="true" value="{{ old('total_amount') }}">
                                                </div>

                                                <div class="col-md-3 col-xl-3 mt-2">
                                                    <label for="interest_charges">Interest Charges 
                                                    </label>
                                                    <input id="interest_charges" type="text" name="interest_charges" class="form-control" value="{{ old('interest_charges') }}">
                                                </div>

                                                <div class="col-md-3 col-xl-3 mt-2">
                                                    <label for="paid">Paid </label>
                                                    <input id="paid" type="text" name="paid" class="form-control" value="{{ old('paid') }}">
                                                </div>

                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="documentation_charge">Documentation Charges </label>
                                                    <input id="documentation_charge" type="text" name="documentation_charge" class="form-control" value="{{ old('documentation_charge') }}">
                                                </div>

                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="balance">Balance</label>
                                                    <input id="balance" type="text" readonly="true" name="balance" class="form-control" value="{{ old('balance') }}">
                                                </div>

                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="first_year_insurance">First Year Insurance </label>
                                                    <input id="first_year_insurance" name="first_year_insurance" class="form-control" value="{{ old('first_year_insurance') }}">
                                                </div>
                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="expanse1">Expense 1 </label>
                                                    <input id="expanse1" type="text" name="expanse1" class="form-control" value="{{ old('expanse1') }}">
                                                </div>

                                                <div class="col-md-8 col-xl-8 mt-2">
                                                    <label for="remark1">Remark 1 </label>
                                                    <textarea id="remark1" name="remark1" class="form-control" value="{{ old('remark1') }}" rows="1" cols="1"></textarea>
                                                </div>
                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="expanse2">Expense 2 </label>
                                                    <input id="expanse2" type="text" name="expanse2" class="form-control" value="{{ old('expanse2') }}">
                                                </div>

                                                <div class="col-md-8 col-xl-8 mt-2">
                                                    <label for="remark2">Remark 2 </label>
                                                    <textarea id="remark2" name="remark2" class="form-control" value="{{ old('remark2') }}" rows="1" cols="1"></textarea>
                                                </div>
                                                <div class="col-md-4 col-xl-4 mt-2">
                                                    <label for="expanse3">Expense 3 </label>
                                                    <input id="expanse3" type="text" name="expanse3" class="form-control" value="{{ old('expanse3') }}">
                                                </div>

                                                <div class="col-md-8 col-xl-8 mt-2">
                                                    <label for="remark3">Remark 3 </label>
                                                    <textarea id="remark3" name="remark3" class="form-control" value="{{ old('remark3') }}" rows="1" cols="1"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xl-12" >
                                                ...
                                                <div class="col-md-3 col-xl-3 mt-2">
                                                    ...
                                                    <input id="agreement_value" type="text" name="agreement_value" class="form-control" readonly="true" value="{{ old('agreement_value') }}">
                                                </div>
    ...
    $('#generate').on('click',function(){
        ...
        for (var i = 0; i < installment_no; i++) {
          agreement_value = Number(agreement_value) - Number(per_installment_amount);
            ...
            html.push('<tr><td>'+i+'</td><td><input class="form-control" name="fist_ins_date_lst[]" value="'+date+'" readonly="true"></td><td><input class="form-control" name="per_ins_amt_lst[]" value="'+per_installment_amount+'" readonly="true"></td><td><input class="form-control" name="agreement_value_lst[]" value="'+agreement_value+'" readonly="true"></td></tr>')
