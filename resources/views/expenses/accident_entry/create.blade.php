		                        ...
		                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
		                        	<div class="row">
		                        		...
		                        		<div class="col-md-4 col-xl-4 mt-2">
					                      ...
					                      <input id="accident_no" class="form-control datepicker" readonly="true" name="accident_no" value="{{old('accident_no') ? old('accident_no') : $no}}" > 
					                        
						                </div>
						                <div class="col-md-4 col-xl-4 mt-2">
			                                <span style="color: #FF0000;font-size:15px;">*</span><label for="Vehicle No."> Entry Date </label>
			                                <input id="entry_date" class="form-control datepicker" readonly="true" name="entry_date" value="{{old('entry_date') ? old('entry_date') : $date}}" >
			                                @error('entry_date')
			                            ...
			                            <div class="col-md-4 col-xl-4 mt-2">
			                               <label for="Vehicle No.">Case No</label>
			                                <input id="case_no" class="form-control" readonly="true" name="case_no" value="{{old('case_no') ? old('case_no') : $case}}" > 
			                                @error('case_no')
				                              <span class="invalid-feedback d-block pull-right" role="alert">
						                ...
						                <div class="col-md-4 col-xl-4 mt-2">
			                                ...
			                                <input id="accident_date" class="form-control datepicker" name="accident_date" value="{{old('date')}}" > 
			                                @error('accident_date')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
				                        ...
				                        <div class="col-md-4 col-xl-4 mt-2">
			                               <label for="Vehicle No.">Driver Name</label>
			                                ...
			                                <input id="driver_name" class="form-control" name="driver_name" value="{{old('driver_name')}}" > 
			                                @error('driver_name')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
				                        ...
				                        <div class="col-md-4 col-xl-4 mt-2">
			                               <label for="Vehicle No.">Total Damage Amt</label>
			                                ...
			                                <input id="total_damage" class="form-control" name="total_damage" value="{{old('total_damage')}}" > 
			                                @error('total_damage')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
					                    ...
					                    <div class="col-md-4 col-xl-4 mt-2">
			                                ...
			                                <input id="paid_by" class="form-control" name="paid_by" value="{{old('paid_by')}}" > 
			                                @error('paid_by')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
					                    ...
					                    <div class="col-md-4 col-xl-4 mt-2">
			                                ...
			                                <input id="total_claim_amount" class="form-control" name="total_claim_amount" value="{{old('total_claim_amount')}}" > 
				                     	...
				                     	<div class="col-md-4 col-xl-4 mt-2">
			                                ...
			                                <input id="claim_date" class="form-control datepicker" name="claim_date" value="{{old('claim_date')}}" > 
			                                @error('claim_date')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
					                    ...
					                    <div class="col-md-4 col-xl-4 mt-2"> 
			                                ...
			                                <input id="net_damage" class="form-control" readonly="true" name="net_damage" value="{{old('net_damage')}}" > 
			                                @error('net_damage')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
				                        ...
				                        <div class="col-md-4 col-xl-4 mt-2">
			                                ...
			                                <input id="paid_date" class="form-control datepicker" name="paid_date" value="{{old('paid_date')}}" > 
			                                @error('paid_date')
					                            <span class="invalid-feedback d-block pull-right" role="alert">
