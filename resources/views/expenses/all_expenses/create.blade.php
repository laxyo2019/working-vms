			                    ...
			                    <div class="row">
			                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
						                ...
						                <div class="row">    
						                	...
						                	<div class="col-md-4 col-xl-4 mt-2">
				                                <label for="party_type">Party Name</label><span style="float: right;"><button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#exampleModal1" ></button></span>
							            ...
							            <div class="row km" style="display: none">
			 							...
			 							<div class="row">     
						                	<div class="col-md-4 col-xl-4 mt-2 fuel_amt" style="display: none">
						                    ...
						                    <div class="col-md-4 col-xl-4 mt-2 avg" style="display: none">
					                        ...
					                        <div class="col-md-4 col-xl-4 mt-2 fuel_qty" style="display: none">
					                        ...
					                        <div class="col-md-4 col-xl-4 mt-2 filling" style="display: none">
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{url('/add_party')}}" method="post">
	      <div class="modal-body">
	      		@csrf
	        <div class="row">
	        	<div class="col-md-12">
	        		<label>Expense Type</label>
	        		<select name="party_type" class="selectpicker form-control">
	                    <option value="">Select..</option>
	                    @foreach($party_types as $party)
	                       <option value="{{$party->expense_type}}">{{$party->expense_type}}</option>
	                    @endforeach     
	        ...
	        <div class="row mt-4">
	        	<div class="col-md-12">
	        		...
	        		<input name="party_name" class="form-control">
	        	</div>
	        </div>
	      </div>
	      <div class="modal-footer">
