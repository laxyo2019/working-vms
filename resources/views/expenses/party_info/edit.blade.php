        ...
        <div class="box box-color orange box-condensed box-bordered">
          <div class="box-title">
            ...
            <div id="add-city-form">
             <form enctype="multipart/form-data" class="well form-horizontal" method="post" action="{{route('party.update',$data->id)}}">
              {{csrf_field()}}
              @method('PATCH')
                 <div class="card-body " >
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
			                ...
			                <div class="row">    
			                	<div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="party_name" class="form-control" name="party_name" value="{{old('party_name') ? old('party_name') : $data->party_name}}" > 
	                                @error('party_name')
		                        ...
		                        <div class="col-md-4 col-xl-4 mt-2">
	                               <span style="color: #FF0000;font-size:15px;">*</span><label for="Vehicle No.">Mobile No</label>	                                
	                                <input id="phone" class="form-control" name="phone" value="{{old('phone') ? old('phone') : $data->phone}}" > 
	                                @error('phone')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
		                        ...
		                        <div class="col-md-4 col-xl-4 mt-2">
	                                <span style="color: #FF0000;font-size:15px;">*</span><label for="party_type">Party Type</label>
	                                
	                                <select id="party_type"  name="party_type" class="selectpicker form-control">
			                            <option value="">Select..</option>
			                            @foreach($exp_type as $exp_type)
			                               <option value="{{$exp_type->expense_type}}" {{$data->party_type == $exp_type->expense_type ? 'selected' : '' }}>{{$exp_type->expense_type}}</option>
			                            @endforeach     
			                        </select> 
	                                @error('party_type')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter Party Type' }}</strong>
			                            </span>
			                         @enderror
	                            </div>	
				             ...
				             <div class="row">
			                    <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="landline_no" class="form-control" name="landline_no" value="{{old('landline_no') ? old('landline_no') : $data->landline_no}}" > 
	                                @error('landline_no')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                    ...
			                    <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="alt_mobile_no" class="form-control" name="alt_mobile_no" value="{{old('alt_mobile_no') ? old('alt_mobile_no') : $data->alt_mobile_no}}" > 
	                                @error('alt_mobile_no')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                	...
			                	<div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="party_website" class="form-control" name="party_website" value="{{old('party_website') ? old('party_website') : $data->party_website}}" > 
	                                @error('party_website')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
 							...
 							<div class="row">     
			                    <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="party_email" type="email" class="form-control" name="party_email" value="{{old('party_email') ? old('party_email') : $data->party_email}}" > 
	                                @error('party_email')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
		                         ...
		                         <div class="col-md-4 col-xl-4 mt-2">
			                       ...
			                       <select id="party_state"  name="party_state" class="selectpicker form-control">
			                            ...
			                            @foreach($state as $State)
			                               <option value="{{$State->id}}" {{$data->party_state == $State->id ? 'selected' : ''}}>{{$State->state_name}}</option>
			                            @endforeach     
			                        </select>
			                        @error('party_state')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
		                    ...
		                    <div class="row">    
		                        <div class="col-md-12 col-xl-12 mt-2">
	                                ...
	                                <textarea id="party_add" class="form-control" name="party_add" value="{{old('party_add') ? old('party_add') : $data->party_add}}" ></textarea> 
	                                @error('party_add')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
