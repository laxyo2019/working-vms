                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xl-12" id="mytable1">
                        	<div class="row">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                <span style="color: #FF0000;font-size:15px;">*</span><label for="Vehicle No.">Goods & Service Tax No</label>
	                        ...
	                        <div class="row">
				                ...
				                <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input id="receipt_id" class="form-control" name="receipt_id" value="{{old('receipt_id')}}" > 
	                                @error('receipt_id')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
	                            ...
	                            <div class="col-md-4 col-xl-4 mt-2">
	                                ...
	                                <input  id="receipt_date" class="form-control datepicker" name="receipt_date" value="{{old('receipt_date')}}" readonly="true"> 
	                                @error('receipt_date')
			                            <span class="invalid-feedback d-block pull-right" role="alert">
			                               <strong>{{ 'Please enter roadtax number' }}</strong>
			                            </span>
